      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <div class="body">
             <form class="in-line" action="<?php echo base_url('prodi/save_ubah/'.$prodi->id_prodi)?>" method="post">
                ...
                <div class="card-body ">
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                     <input type="text" id="nama_prodi" name="nama_prodi" class="form-control" value="<?= $prodi->nama_prodi ?>">
                   </div>
                 </div>
