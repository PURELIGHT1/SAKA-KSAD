...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensi2/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensi2/petugas_piket/siswa" class="tip-bottom">Siswa</a> <a href="#" class="current">Absen</a>
    </div>
    <h1>Siswa</h1>
  </div>
  <!--End Coulumn Header -->
            ...
            <div class="table-responsive">
              ...
              <form method="post" action="./proses.php?kategori=absen_siswa">
                ...
                <table class="table table-bordered table-striped with-check">
                  ...
                  <!--End Tabel Baris 1(nama kolom)-->

                  <!--Isi Tabel Baris 1(nama kolom)-->
                  <tbody>
                    <?php $no = 1;
