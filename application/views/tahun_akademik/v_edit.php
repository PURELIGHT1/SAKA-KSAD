      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Update tahun akademik</h1>
          </div>
          <div class="section-body">
            <div class="body">
             <form class="in-line" action="<?php echo base_url('tahun_akademik/save_ubah/'.$ta->id_tahun_akademik)?>" method="post">
                ...
                <div class="card-body ">
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <input type="text" id="tahun_akademik" name="tahun_akademik" class="form-control" value="<?= $ta->tahun_akademik ?>">
                    </div>
                  </div>
